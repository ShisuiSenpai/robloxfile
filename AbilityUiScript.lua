...
-- CLEAN UI CREATOR/UPDATER - Single responsibility with ENHANCED DEBUG
...
-- SINGLE RESPONSIBILITY MONITOR - Only detects changes, doesn't manage timers - ENHANCED DEBUG
local function monitorServerAttributes()
	...
	-- DEBUG: Print current attribute values every few seconds
	if math.random(1, 300) == 1 then -- Randomly print debug info
		print("🔍 DEBUG - SpeedBoost attribute:", speedBoost)
		print("🔍 DEBUG - SpeedBoost_Expiry:", speedBoostExpiry)
		print("🔍 DEBUG - Current time:", currentTime)
		if speedBoostExpiry then
			print("🔍 DEBUG - Remaining time:", speedBoostExpiry - currentTime)
		end
	end
