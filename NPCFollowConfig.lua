...
NPCFollowConfig.ENABLE_COMBAT_SYSTEM = true -- Enable the combat system
NPCFollowConfig.ATTACK_RANGE = 5 -- Range at which NPC can attack (studs)
NPCFollowConfig.COMBO_HIT_COUNT = 5 -- Number of hits in a combo
NPCFollowConfig.DAMAGE_PER_HIT = 10 -- Damage dealt per hit
NPCFollowConfig.HIT_INTERVAL = 0.4 -- Time between combo hits (seconds)
NPCFollowConfig.COMBO_COOLDOWN = 2 -- Time before NPC can start another combo (seconds)
NPCFollowConfig.PLAYER_STUN_DURATION = 0.2 -- How long player is stunned per hit (seconds)
NPCFollowConfig.KNOCKBACK_FORCE = 10 -- Force applied to player on hit
NPCFollowConfig.COMBAT_MOVEMENT_SPEED = 12 -- Speed during combat
NPCFollowConfig.ATTACK_TELEGRAPH_TIME = 0.3 -- Time before attack lands (for player reaction)
NPCFollowConfig.SHOW_ATTACK_INDICATOR = true -- Show attack warning indicator
NPCFollowConfig.ATTACK_INDICATOR_COLOR = Color3.new(1, 0.3, 0) -- Orange color for attack warning

-- DAMAGE SYSTEM SETTINGS (Legacy - keeping for compatibility)
NPCFollowConfig.ENABLE_DAMAGE_SYSTEM = false -- Disable old damage system in favor of combat system
...
NPCFollowConfig.DAMAGE_HITBOX_VISIBLE = false -- Whether damage hitbox is visible (toggle for dev/production)
...
-- DEBUG SETTINGS
NPCFollowConfig.DEBUG_MODE = true -- Enable debug prints for troubleshooting
