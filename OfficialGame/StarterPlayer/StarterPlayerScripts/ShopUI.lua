...
local GAMEPASSES = {
	{
		id = 1565964380, -- Replace with real gamepass ID
		name = "2x Push Boost",
		description = "Push players twice as far with your tool",
		price = 99,
		icon = "rbxassetid://73765787740981" -- Placeholder icon
	},
	{
		id = 1564540363,
		name = "2x Wins",
		...
		price = 149,
		icon = "rbxassetid://92604082629429"
	},
	{
		id = 1565502306,
		name = "Speed Boost",
		description = "Move 50% faster during rounds",
		price = 49,
		icon = "rbxassetid://77464729611566"
	},
	{
		id = 1565200369,
		name = "HD Admin",
		...
		price = 499,
		icon = "rbxassetid://74768126649517"
	}
}
-- ==================== UI CREATION ====================
...
shopButton.BackgroundTransparency = 0.35
