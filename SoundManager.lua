...
local SOUND_IDS = {
	-- Countdown sounds
	countdown_tick = "rbxassetid://9120386436",      -- Tick sound for 3, 2, 1
	countdown_go = "rbxassetid://9120386436",        -- GO! sound
	
	-- King of the Hill sounds
	become_king = "rbxassetid://9120386436",         -- When you become king
	king_tick = "rbxassetid://9113939301",           -- Subtle tick while king timer counts
	player_wins = "rbxassetid://9120386436",         -- Victory sound
	
	-- Intermission sounds
	intermission_tick = "rbxassetid://9113939301",   -- Quiet tick during intermission
	
	-- Push tool sounds
	push_swing = "rbxassetid://9119713951",          -- Swing/whoosh sound when pushing
	push_hit = "rbxassetid://9119713951",            -- Impact sound when hitting player
}
